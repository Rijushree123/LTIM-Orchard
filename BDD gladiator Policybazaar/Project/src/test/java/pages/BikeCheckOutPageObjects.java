...
public class BikeCheckOutPageObjects {
    ...
    public void enterFullName(String str,ExtentTest test) {
        try {
            String file = System.getProperty("user.dir") + "/testdata/Testdata.xlsx";
            String name = ExcelReader.readDatafromExcel(file, "Sheet1", Integer.parseInt(str), 3);
    ...
    public void enterEmail(String str, ExtentTest test) {
        try {
            String file = System.getProperty("user.dir") + "/testdata/Testdata.xlsx";
            String email = ExcelReader.readDatafromExcel(file, "Sheet1", Integer.parseInt(str), 3);
    ...
    public void enterMobileNumber(String str, ExtentTest test) {
        try {
            String file = System.getProperty("user.dir") + "/testdata/Testdata.xlsx";
            String phone = ExcelReader.readDatafromExcel(file, "Sheet1", Integer.parseInt(str), 3);
