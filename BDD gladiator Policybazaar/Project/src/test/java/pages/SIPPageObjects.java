...
public class SIPPageObjects {
    ...
    public void enterUsername(ExtentTest test,String str) {
        try {
    ...
    public void enterMobileNumber(ExtentTest test,String str) {
        try {
            String data = ExcelReader.readDatafromExcel("./testdata/Testdata.xlsx", "Sheet1", Integer.parseInt(str), 2);
            helperObj.sendKeys(sipLocatorsObj.getClickMobileNumber(), data);
