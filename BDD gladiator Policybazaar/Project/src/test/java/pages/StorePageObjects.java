...
public class StorePageObjects {
    ...
    public void enterSearch(ExtentTest test, String str) {
        try {
            helperObj.sendKeys(storepageLocatorsObj.getClickOnSearch(), ExcelReader.readDatafromExcel("./testdata/Testdata.xlsx", "Sheet1", Integer.parseInt(str), 9));
