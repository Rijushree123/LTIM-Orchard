...
public class CustomerDetailsPageObjects {
    ...
    public void enterEmail(String str, ExtentTest test) {
        try {
            String data = ExcelReader.readDatafromExcel("./testdata/Testdata.xlsx", "Sheet1", Integer.parseInt(str), 2);
    ...
    public void enterDOB(String str, ExtentTest test) {
        try {
            String data = ExcelReader.readDatafromExcel("./testdata/Testdata.xlsx", "Sheet1", Integer.parseInt(str), 2);
    ...
    public void enterAnnualIncome(String str, ExtentTest test) {
        try {
            String data = ExcelReader.readDatafromExcel("./testdata/Testdata.xlsx", "Sheet1", Integer.parseInt(str), 2);
    ...
    public void enterPincodeInCustomerDetails(String pin, ExtentTest test) {
        try {
            String data = ExcelReader.readDatafromExcel("./testdata/Testdata.xlsx", "Sheet1", Integer.parseInt(pin), 2);
