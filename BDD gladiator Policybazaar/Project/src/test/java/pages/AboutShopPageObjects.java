...
public class AboutShopPageObjects {
    ...
    public void enterValue(ExtentTest test,String str) {
        try {
            String message = "Entering Value successful";
            helperObj.sendKeys(aboutLocatorsObj.getClickValue(), ExcelReader.readDatafromExcel("./testdata/Testdata.xlsx", "Sheet1", Integer.parseInt(str), 4));
