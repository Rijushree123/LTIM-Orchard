...
public class FDCalculatorPageObjects {
	...
	public void enterOnName(ExtentTest test, String data) {
		try {
			webDriverHelper.sendKeys(fdCalculatorPageLocators.getName(), ExcelReader.readDatafromExcel(excelFilePath, sheetName, Integer.parseInt(data), 8));
	...
	public void enterOnMobile(ExtentTest test, String data) {
		try {
			webDriverHelper.sendKeys(fdCalculatorPageLocators.getMobile(), ExcelReader.readDatafromExcel(excelFilePath, sheetName, Integer.parseInt(data), 8));
